...
``` r
# Pakiet EpiStats jest to pakiet zawierający narzędzia dla epidemiologów.
# Zainteresował mnie, ponieważ umożliwia pomoc w badaniach kohortowych i kliniczych.
```
