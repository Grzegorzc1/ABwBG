...
```
Wytworzenie wykresu z wieloma słupkami ze zbioru danych 
...
# Volcano Plot
Wytworzenie wykresu wulkanicznego ze zbioru danych 
...
# Heatmap
Wytworzenie wykresu Heatmap ze zbioru danych, charakteryzująca się różnymi kolorami w zale zności od zmiennej. Możliwość porównania zmiennych
```{r}
...
# Manhattan Plot
służy do badań asocjacyjnych, pozwala wykryć który region w chromosomie istotnie oddziałuje na dany fenotyp
```{r}
